...
#
#     PHX_SERVER=true bin/aebc start
#
...
if config_env() == :prod do
  ...
  host = System.get_env("PHX_HOST") || "aebc.lambdao.org"
  ...
  config :aebc, AebcWeb.Endpoint,
    ...
    check_origin: ["https://aebc-confucius.org", "https://www.aebc-confucius.org"],
    http: [
